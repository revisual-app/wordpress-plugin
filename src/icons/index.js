...
export const Eye = (props) => (
  <Svg {...props}>
    <path d="M2.42 12.71c-.14-.22-.2-.33-.24-.5a1.2 1.2 0 0 1 0-.42c.04-.17.1-.28.24-.5C3.55 9.5 6.9 5 12 5s8.45 4.5 9.58 6.29c.14.22.2.33.24.5a1.2 1.2 0 0 1 0 .42c-.04.17-.1.28-.24.5C20.45 14.5 17.1 19 12 19s-8.45-4.5-9.58-6.29Z" />
